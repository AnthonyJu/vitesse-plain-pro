...
import '@/components/cesium-map/components/zoom-controller/styles/zoom-controller.scss'
...
class ZoomController extends Widget {
  ...
  _mountContent() {
    ...
    this._zoomInEl.title = tips?.zoomIn ?? '放大'
    this._zoomOutEl.title = tips?.zoomOut ?? '缩小'
    this._refreshEl.title = tips?.refresh ?? '重置'
